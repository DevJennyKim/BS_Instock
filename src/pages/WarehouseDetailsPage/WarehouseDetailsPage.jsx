...
function WarehouseDetailsPage() {
    ...
    if (!warehouseDetails) {
        return <div className="warehouse-details__error">No warehouse details found</div>;
    }
            ...
            <div className="warehouse-details__info">
                ...
                <div className="warehouse-details__contact">
                    <div className="warehouse-details__contact-name">
                        ...
                        <p className="warehouse-details__text">{warehouseDetails.contact_name}</p>
                    ...
                    <div className="warehouse-details__contact-info">
                        ...
                        <p className="warehouse-details__text">{warehouseDetails.contact_phone}</p>
                        <p className="warehouse-details__text">{warehouseDetails.contact_email}</p>
                    </div>
                </div>
            </div>
            <div className="warehouse-details__inventory">
                <div className="warehouse-details__column-headers">
                    <div className="warehouse-details__column-header-container">
                        ...
                        <img src={sortIcon} alt="sort" className="warehouse-details__sort-icon" />
                    </div>
                    <div className="warehouse-details__column-header-container">
